...
export const FormBuilder: React.FC<FormBuilderProps> = ({ formId }) => {
  ...
  const handleImportSuccess = (schema: FormSchema) => {
    actions.setFormSchema(schema);
    actions.setShowImportModal(false);
    actions.setHasUnsavedChanges(true);
    toast.success('Form imported successfully! Remember to save your changes.');
  };
    ...
    return (
      <div className="flex h-screen flex-col overflow-hidden bg-background">
        ...
        <FormBuilderModals
          ...
          onCloseImportModal={() => actions.setShowImportModal(false)}
